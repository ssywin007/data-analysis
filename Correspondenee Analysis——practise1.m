...
r2=r(:,2:3)*DS(2:3,2:3)^0.5;
s2=s(:,2:3)*DS(2:3,2:3)^0.5;
%plotting
...
%title 2,1,4 need more knowledge than title 6,5,3; people in province 1,7,8,3 are more knowledgable than people in other provinces.
